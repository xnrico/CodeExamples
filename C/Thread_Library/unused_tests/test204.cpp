...
// CV TEST 204, Broadcasting without a lock (one child thread) -> Should not be a problem
...
void child1(void *arg) {
    ...
    std::cout << "[Child " << *((size_t*) arg) << "] does not have lock and about to do work\n";
    ...
    c.broadcast();
    assert_interrupts_enabled();
    std::cout << "[Child " << *((size_t*) arg) << "] completed work and broadcasted (to child 0)\n";
