...
// CV TEST 201, Signaling without a lock -> should not be a problem
...
void child1(void *arg) {
    ...
    assert_interrupts_enabled();
    std::cout << "[Child " << *((size_t*) arg) << "] does not have lock m and about to do work\n";
    ...
    c.signal();
    assert_interrupts_enabled();
    std::cout << "[Child " << *((size_t*) arg) << "] completed work without a lock and signaled child 0\n";
